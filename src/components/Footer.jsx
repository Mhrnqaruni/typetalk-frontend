...
/* Social icons — inline SVGs (lucide-react v1 has no social icons) */
const socials = [
  {
    label: 'X (Twitter)',
      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <Link className="brand" to="/" aria-label="Typeless home">
          ...
          <nav className="footer-col" aria-label="Resources links">
            ...
            <ul>
              ...
              <li><Link to="#">Typeless for students</Link></li>
